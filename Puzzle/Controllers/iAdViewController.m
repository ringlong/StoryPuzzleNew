...
- (void)bannerViewDidLoadAd:(ADBannerView *)banner
{
    ...
    [self adjustBannerViewWithOrientation:[UIApplication sharedApplication].statusBarOrientation];
    adPresent = YES;
}
...
- (BOOL)bannerViewActionShouldBegin:(ADBannerView *)banner willLeaveApplication:(BOOL)willLeave
{
    ...
    prevOrientation = [UIApplication sharedApplication].statusBarOrientation;
    return YES;
}
...
- (void)bannerViewActionDidFinish:(ADBannerView *)banner
{
    ...
    if ([UIApplication sharedApplication].statusBarOrientation != prevOrientation) [(PuzzleController*)self fuckingRotateTo:[UIApplication sharedApplication].statusBarOrientation duration:0.5];
    [self adjustBannerViewWithOrientation:[UIApplication sharedApplication].statusBarOrientation];
